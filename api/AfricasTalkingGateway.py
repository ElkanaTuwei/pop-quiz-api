...
class AfricasTalkingGateway:
    def __init__(self):
        ...
        self.api_key = "dbfa3c79b07b8b35018282c3cd39b38db29e869d923a435affaed867e152ee22"
        self.SMSURLString = "https://api.sandbox.africastalking.com/version1/messaging"
    ...
    # Messaging methods
    def sendMessage(self, to_, message_, from_=None, bulkSMSMode_=0, enqueue_=0, keyword_=None, linkId_=None,
        ...
        response = sms.send(message_, [to_])
        print(response)
        return response
